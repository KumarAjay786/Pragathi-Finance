...
SECRET_KEY = 'django-insecure-i9mr_(%t7_5_afo4ao@jik01cg1v%x&l_zm--(hna0cc9pyxa9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['pragathifs.com', 'www.pragathifs.com', '*']
...
INSTALLED_APPS = [
    ...
    'api.apps.ApiConfig',  # Ensure your app is included here
]
